...
public class Utility {
    ...
    public Utility() throws FileNotFoundException {
        ...
        Scanner enemiesFile = new Scanner(new File(enemiesPath));
        Scanner movesFile = new Scanner(new File(movesPath));

        Enemy enemy;
        String[] line;
        while (enemiesFile.hasNextLine()) {
            line = enemiesFile.nextLine().split(",");
            enemy = new Enemy(line[0], Double.parseDouble(line[1]), Double.parseDouble(line[2]),
                    Double.parseDouble(line[3]), Double.parseDouble(line[4]));
            enemies.add(enemy);
        }

        while (movesFile.hasNextLine()) {
            movesList.add(movesFile.nextLine());
        }
    ...
    public void choosePowerUp(Hero hero, Enemy enemy) {
        ...
        for (int i = 0; i < powerUpsList.size(); i++) {
            ...
            if (powerUpsList.get(i) instanceof DefenseAmulet) {
                switch (powerUpsList.get(i).getName().toLowerCase()) {
            ...
            if (powerUpsList.get(i) instanceof AttackAmulet) {
                switch (powerUpsList.get(i).getName().toLowerCase()) {
        ...
        if (smallPotionCount > 0) System.out.println("p - Small Potions: " + smallPotionCount + " in possession");
        if (largePotionCount > 0) System.out.println("g - Large Potions: " + largePotionCount + " in possession");
        if (commonDefenseAmuletCount > 0) System.out.println("d - Common Defense Amulets: " + commonDefenseAmuletCount + " in possession");
        if (rareDefenseAmuletCount > 0) System.out.println("a - Rare Defense Amulets: " + rareDefenseAmuletCount + " in possession");
        if (epicDefenseAmuletCount > 0) System.out.println("k - Epic Defense Amulets: " + epicDefenseAmuletCount + " in possession");
        if (commonStrengthAmuletCount > 0) System.out.println("m - Common Strength Amulets: " + commonStrengthAmuletCount + " in possession");
        if (rareStrengthAmuletCount > 0) System.out.println("r - Rare Strength Amulets: " + rareStrengthAmuletCount + " in possession");
        if (epicStrengthAmuletCount > 0) System.out.println("e - Epic Strength Amulets: " + epicStrengthAmuletCount + " in possession");
        ...
        if (!(choice.equalsIgnoreCase("0")) && check2) {
 ...
 // Method for printing after an Enemy attack
    ...
    public void inventoryMapMessage() {
        System.out.println("Power-up array size: " + powerUpsList.size());
        if (powerUpsList.size() > 0) {
            System.out.println("5 - View Your Power-Ups");
        }
    }
